            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama_stok" class="col-lg-2 col-lg-offset-1 control-label">Nama</label>
                        <div class="col-lg-6">
                            <input type="text" name="nama_stok" id="nama_stok" class="form-control" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="diskon" id="diskon" class="form-control"required min="0"  value="0">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="stok" id="stok" class="form-control"required min="0"  required value="0">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
