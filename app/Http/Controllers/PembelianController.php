...
class PembelianController extends Controller
{
    public function index()
    {
        ...
        return view('pembelian.index', compact('karyawan'));
    }
    ...
    public function data()
    {
        ...
        return datatables()
           ...
           ->addColumn('karyawan', function ($pembelian) {
    return $pembelian->karyawan ? $pembelian->karyawan->nama : 'Tidak Diketahui';
})
    ...
    public function create($id)
    {
        ...
        session(['id_karyawan' => $pembelian->id_karyawan]);
